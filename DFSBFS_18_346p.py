...
구현문제 아닌가?
아이디어를 낼만한게 있나?
재귀함수를 만드는게 아이디어를 생각해내는건가?
재귀함수는 스택으로 구현하니깐 DFS랑 관련이 있겠네
...
저자는 이것이 DFS BFS문제가 아니라 구현 문제라고 한다.
정확한 구현을 위해서 실수를 예방하기 위해 구현을 단순화할 필요가 있다고 한다.
"".join() 에 대해서 숙지하자
